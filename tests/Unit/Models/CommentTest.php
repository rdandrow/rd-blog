...
describe('relationships', function () {
    test('has blog post relationship', function () {
        ...
        expect($relationship)->toBeInstanceOf(BelongsTo::class)
            ...
            ->and($comment->blogPost->id)->toBe($this->post->id)
            ->and($comment->blogPost->title)->toBe($this->post->title);
    });
    ...
    test('has user relationship', function () {
        ...
        expect($relationship)->toBeInstanceOf(BelongsTo::class)
            ...
            ->and($comment->user->name)->toBe($this->user->name);
    });

    test('has parent comment relationship', function () {
        // Arrange: Create parent comment and reply
        ...
        expect($relationship)->toBeInstanceOf(BelongsTo::class)
            ...
            ->and($reply->parent->content)->toBe($parent->content);
    });
