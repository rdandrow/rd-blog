...
<template>
    ...
    >
        <div
            v-if="isOpen"
            class="fixed top-0 right-0 z-50 h-full w-full overflow-y-auto bg-white shadow-2xl sm:w-96 dark:bg-gray-900"
        ...
        >
            ...
            <div class="space-y-6 p-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="w-full rounded-lg border border-gray-300 bg-white py-3 pr-4 pl-10 text-gray-900 placeholder-gray-500 focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 dark:focus:ring-blue-400"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select
                            id="sidebar-tag"
                            v-model="selectedTag"
                            class="w-full cursor-pointer appearance-none rounded-lg border border-gray-300 bg-white py-3 pr-4 pl-10 text-gray-900 focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:focus:ring-blue-400"
                        >
                ...
                <button
                    @click="applyFilters"
                    class="w-full rounded-lg bg-blue-600 px-6 py-3 font-medium text-white shadow-sm transition-colors hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-offset-gray-900"
                >
                    Apply Filters
                </button>
