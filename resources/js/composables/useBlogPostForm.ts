import { ALLOWED_IMAGE_TYPES, MAX_IMAGE_FILE_SIZE } from '@/constants/editor';
import { ref } from 'vue';
        ...
        try {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    imageError.value =
                        'Error creating image preview. The file will still be uploaded.';
                }
            };
            ...
            reader.onerror = () => {
                ...
                imageError.value =
                    'Error reading the selected file. Please try again.';
                target.value = '';
            };
