...
import type { AppPageProps, Author, BlogPost, SearchFilters } from '@/types';
        ...
        <section class="bg-muted/50 py-16">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
                    Discover insights, tutorials, and stories from my journey as
                    a quality engineer.
                </p>
            </div>
        </section>
            ...
            <div class="container mx-auto px-4 text-center">
                ...
                <form class="mx-auto flex max-w-md flex-col gap-4 sm:flex-row">
                    <input
                        ...
                        class="flex-1 rounded border border-border bg-background px-4 py-2 text-foreground"
                    />
                    <button
                        type="submit"
                        class="rounded bg-primary px-6 py-2 text-primary-foreground transition-colors hover:bg-primary/90"
                    >
                        Subscribe
                    </button>
                </form>
