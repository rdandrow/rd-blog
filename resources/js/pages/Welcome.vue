                        ...
                        >
                            <Link :href="`/blog/${post.slug}`" class="block">
                                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow">
                                    <div class="aspect-video bg-gradient-to-br from-blue-100 to-purple-100 dark:from-gray-700 dark:to-gray-600"></div>
                                    <div class="p-6">
                ...
                <div v-if="posts && posts.length > 0">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        >
                            <Link :href="`/blog/${post.slug}`" class="block">
                                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow">
                                    <div class="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-600 dark:to-gray-700"></div>
                                    <div class="p-4">
