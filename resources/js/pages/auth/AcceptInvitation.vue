...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8 dark:bg-gray-900"
    >
        <div class="w-full max-w-md">
            ...
            <div
                class="rounded-lg bg-white p-6 shadow-sm sm:p-8 dark:bg-gray-800"
            >
