  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    <div v-else class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold text-foreground">My Drafts</h1>
          <p class="text-muted-foreground">View and manage your unpublished blog posts</p>
        </div>
      ...
      <div class="bg-card border border-border rounded-lg overflow-hidden">
        <div v-if="!props.posts?.data || props.posts.data.length === 0" class="p-8 text-center">
          ...
          <h3 class="text-lg font-semibold text-foreground mb-2">No drafts yet</h3>
          <p class="text-muted-foreground mb-4">All your unpublished posts will appear here.</p>
          <Link
            href="/admin/blog-posts/create"
            class="inline-flex items-center px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors"
          >
